...
class MoviesForm(ModelForm):
    class Meta:
        ...
        labels = {
            ...
            'HardDrive': mark_safe('<img src="/media/local_icos/hdd_ico.jpg">'),
            'Netflix': mark_safe('<img src="/media/local_icos/flix_ico.jpg">'),
            'HboGO': mark_safe('<img src="/media/local_icos/hbo_ico.jpg">'),
            'AmazonPrime': mark_safe('<img src="/media/local_icos/prime_ico.jpg">')
        }
